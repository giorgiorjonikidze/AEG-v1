    ...
    <>
      <div className="tp-booking-card" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: 6 }}>
          <span style={{ fontFamily: "'Spectral',serif", fontWeight: 500, fontSize: 48, lineHeight: 1, color: '#1E1C19' }}>{priceStr}</span>
        ...
        <div style={{ fontFamily: "'Hanken Grotesk',sans-serif", fontSize: 13.5, lineHeight: 1.5, color: '#A8A296', marginTop: 10 }}>
          Varies by group size · {tour.quickFacts.duration} · {tour.region}
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 24 }}>
          <button type="button" onClick={() => setOpen(true)} className="bc-btn bc-primary"
