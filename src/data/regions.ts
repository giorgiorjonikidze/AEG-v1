...
export const REGIONS_DATA: RegionData[] = [
  {
    ...
    tours: [
      ...
      {
        name: 'Mount Kazbek Summit Expedition',
        hook: 'Rope up for the 5,054 m glaciated crown of the eastern Caucasus.',
        duration: '6 days',
        ...
        href: '/en/tours/kazbek-summit',
      },
      {
        name: 'Khevsureti Overland Expedition',
        hook: 'A 4×4 journey to the medieval towers of Shatili and Mutso.',
        duration: '4 days',
        regionActivity: 'Mtskheta-Mtianeti · Overlanding',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/jason-gardner-LU-o3CbeZhU-unsplash.jpg',
        href: '/en/tours/khevsureti-overland',
      },
      {
        name: 'Juta–Chaukhi Trek',
        hook: 'Alpine meadows beneath the dolomite spires of the Chaukhi massif.',
        duration: '3 days',
        regionActivity: 'Mtskheta-Mtianeti · Trekking & Hiking',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/k-t-xVLdFIxcDCc-unsplash.jpg',
        href: '/en/tours/juta-chaukhi-trek',
      },
    ],
  ...
  },
  {
    ...
    tours: [
      {
        name: 'Prometheus Cave Explorer',
        hook: 'Lit galleries of stalactites along an underground river.',
        duration: 'Day trip',
        ...
        badge: '',
        image: '/images/tours/jairph-Edx0NpJ29fQ-unsplash.jpg',
        href: '/en/tours/prometheus-cave',
      },
      {
        name: 'Martvili Canyon Day Trip',
        hook: 'Boat the emerald gorge and swim beneath waterfalls.',
        duration: 'Day trip',
        ...
        badge: '',
        image: '/images/tours/wander-creative-6i3O_w7wOyE-unsplash.jpg',
        href: '/en/tours/martvili-canyon',
      },
      {
        name: 'Sataplia & Prometheus Combined Day',
        hook: 'Dinosaur footprints, a glass forest platform and illuminated cave chambers in one Imereti day.',
        duration: 'Day trip',
        regionActivity: 'Imereti · Caving',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nadav-fima-ULn5jbPuHx8-unsplash.jpg',
        href: '/en/tours/sataplia-prometheus',
      },
      {
        name: 'Okatse Canyon & Kinchkha Falls',
        hook: "Georgia's most dramatic canyon walkway, plus a multi-tier waterfall.",
        duration: 'Day trip',
        regionActivity: 'Imereti · Trekking & Hiking',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/wander-creative-6i3O_w7wOyE-unsplash.jpg',
        href: '/en/tours/okatse-canyon',
      },
    ],
    ...
    tours: [
      {
        ...
        hook: "Four valleys, two ranges, and Europe's highest village.",
        duration: '4 days',
        ...
        badge: '',
        image: '/images/tours/johannes-andersson-pmtllkyavOk-unsplash.jpg',
        href: '/en/tours/mestia-ushguli',
      },
      {
        name: 'Svaneti Glacier Trek',
        hook: 'Glacier crossings and tower-village nights in upper Svaneti.',
        duration: '4 days',
        regionActivity: 'Svaneti · Trekking & Hiking',
        difficulty: 'Moderate',
        isNew: true,
      ...
      {
        name: 'Mount Tetnuldi Ascent',
        hook: 'A guided high-altitude ascent above the Svan glaciers.',
        duration: '7 days',
        regionActivity: 'Svaneti · Summit Experience',
        difficulty: 'Challenging',
        isNew: false,
        badge: '',
        image: '/images/tours/tomas-malik-EtvlvO4cF5I-unsplash.jpg',
        href: '/en/tours/tetnuldi-ascent',
      },
    ],
    ...
    tours: [
      {
        ...
        hook: 'Boat the emerald gorge and swim beneath waterfalls.',
        duration: 'Day trip',
        regionActivity: 'Samegrelo · Canyoning',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/wander-creative-6i3O_w7wOyE-unsplash.jpg',
      ...
      {
        name: 'Samegrelo & Svaneti Gateway',
        hook: 'Mingrelian heritage, Enguri Dam and the road into the high Caucasus.',
        duration: '2 days',
        regionActivity: 'Samegrelo · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/vasily-ledovsky-7Nl6vSXdDhE-unsplash.jpg',
        href: '/en/tours/samegrelo-svaneti-gateway',
      },
      {
        name: 'Kolkheti Wetlands & Martvili',
        hook: 'Colchis birdwatching in the morning, canyon boat trip in the afternoon.',
        duration: '2 days',
        regionActivity: 'Samegrelo · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/jason-gardner-LU-o3CbeZhU-unsplash.jpg',
        href: '/en/tours/kolkheti-martvili',
      },
      {
        name: 'Nokalakevi & Zugdidi Heritage Day',
        hook: "Ancient Colchis ruins and the Dadiani Palace — one of Europe's most unusual museum collections.",
        duration: 'Day trip',
        regionActivity: 'Samegrelo · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nino-gakhokia-24d9N5UsVYs-unsplash.jpg',
        href: '/en/tours/nokalakevi-zugdidi',
      },
    ],
  ...
  // ── KAKHETI ──────────────────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'Kakheti Wine & Bike Tour',
        hook: "Pedal vineyard to vineyard through Georgia's wine country.",
        duration: '2 days',
        regionActivity: 'Kakheti · Biking',
        difficulty: 'Easy',
        isNew: true,
        badge: 'New',
        image: '/images/tours/gio-chanturia-2aGoA1zcWfI-unsplash.jpg',
        href: '/en/tours/kakheti-wine-bike',
      },
      {
        ...
        badge: '',
        image: '/images/tours/jason-gardner-LU-o3CbeZhU-unsplash.jpg',
        href: '/en/tours/vashlovani-overland',
      },
      {
        name: 'Tusheti Overland Expedition',
        hook: "4×4 over Abano Pass into Georgia's wildest highlands.",
        duration: '5 days',
        regionActivity: 'Kakheti · Overlanding',
        difficulty: 'Moderate',
        isNew: true,
        badge: 'New',
        image: '/images/tours/iman-gozal-5iQWgow3_S0-unsplash.jpg',
        href: '/en/tours/tusheti-overland',
      },
      {
        name: 'Highlights of Georgia',
        hook: 'Mountains, wine, caves and old towns in one loop.',
        duration: '7 days',
        regionActivity: 'Kakheti · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nino-gakhokia-24d9N5UsVYs-unsplash.jpg',
        href: '/en/tours/georgia-highlights',
      },
    ],
  ...
  // ── RACHA-LECHKHUMI ──────────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'Black Rock Lake Hike',
        hook: 'An easy forest loop to a mirror-calm alpine lake.',
        duration: 'Day trip',
        regionActivity: 'Racha · Trekking & Hiking',
        difficulty: 'Easy',
        isNew: true,
        badge: 'New',
        image: '/images/tours/nadav-fima-ULn5jbPuHx8-unsplash.jpg',
        href: '/en/tours/black-rock-lake',
      },
      {
        name: 'Racha Wine & Mountains',
        hook: "Khvanchkara cellars, alpine meadows and the quietest valleys in Georgia.",
        duration: '3 days',
        regionActivity: 'Racha · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/gio-chanturia-2aGoA1zcWfI-unsplash.jpg',
        href: '/en/tours/racha-wine-mountains',
      },
      {
        name: 'Racha–Lechkhumi Overland',
        hook: 'Remote gorges, reservoir roads and ancient villages by 4×4.',
        duration: '3 days',
        regionActivity: 'Racha · Overlanding',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/jason-gardner-LU-o3CbeZhU-unsplash.jpg',
        href: '/en/tours/racha-overland',
      },
      {
        name: 'Caucasus Ridge Trek (Racha)',
        hook: 'Multi-day traverse along the southern Caucasus ridgeline.',
        duration: '4 days',
        regionActivity: 'Racha · Trekking & Hiking',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/vasily-ledovsky-7Nl6vSXdDhE-unsplash.jpg',
        href: '/en/tours/racha-ridge-trek',
      },
    ],
  ...
  // ── ADJARA ───────────────────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'Adjara Coast & Mountain Ride',
        hook: 'From Black Sea beaches up into the Adjara highlands.',
        duration: '3 days',
        regionActivity: 'Adjara · Biking',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/zviad-pharsenadze--cIcGJX4Gxk-unsplash.jpg',
        href: '/en/tours/adjara-coast-ride',
      },
      {
        name: 'Adjara Highlands Trek',
        hook: 'Subalpine meadows, village guesthouses and views to Turkey from Goderdzi Pass.',
        duration: '3 days',
        regionActivity: 'Adjara · Trekking & Hiking',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/kim-cordenete-3hB68obZnHI-unsplash.jpg',
        href: '/en/tours/adjara-highlands-trek',
      },
      {
        name: 'Kintrishi Canyon Day',
        hook: 'Jungle-clad canyon walks and the Makhuntseti waterfall from Batumi.',
        duration: 'Day trip',
        regionActivity: 'Adjara · Canyoning',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/wander-creative-6i3O_w7wOyE-unsplash.jpg',
        href: '/en/tours/kintrishi-canyon',
      },
      {
        name: 'Batumi & Adjara Discovery',
        hook: 'City, coast, tea hills and a highland village — Adjara in three days.',
        duration: '3 days',
        regionActivity: 'Adjara · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/zviad-pharsenadze--cIcGJX4Gxk-unsplash.jpg',
        href: '/en/tours/batumi-adjara-discovery',
      },
    ],
  ...
  // ── SAMTSKHE-JAVAKHETI ───────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'Vardzia Cave City Day Trip',
        hook: "Queen Tamar's 12th-century cave monastery — one of Georgia's greatest sights.",
        duration: 'Day trip',
        regionActivity: 'Samtskhe-Javakheti · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nika-tchokhonelidze-Ms_p0I5DQSM-unsplash.jpg',
        href: '/en/tours/vardzia-day-trip',
      },
      {
        name: 'Borjomi & Vardzia Explorer',
        hook: 'Mineral springs, a national park and a cave city — southern Georgia in three days.',
        duration: '3 days',
        regionActivity: 'Samtskhe-Javakheti · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nadav-fima-ULn5jbPuHx8-unsplash.jpg',
        href: '/en/tours/borjomi-vardzia',
      },
      {
        name: 'Javakheti Plateau Overland',
        hook: 'Crater lakes, volcanic highland and a world away from the tourist trail.',
        duration: '2 days',
        regionActivity: 'Samtskhe-Javakheti · Overlanding',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/jason-gardner-LU-o3CbeZhU-unsplash.jpg',
        href: '/en/tours/javakheti-overland',
      },
      {
        name: 'Borjomi–Kharagauli Trek',
        hook: 'Multi-day trail through the forests of one of Europe\'s largest national parks.',
        duration: '3 days',
        regionActivity: 'Samtskhe-Javakheti · Trekking & Hiking',
        difficulty: 'Moderate',
        isNew: false,
        badge: '',
        image: '/images/tours/vasily-ledovsky-7Nl6vSXdDhE-unsplash.jpg',
        href: '/en/tours/borjomi-kharagauli-trek',
      },
    ],
  ...
  // ── GURIA ────────────────────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'Guria Discovery Day',
        hook: 'Hidden monasteries, hazelnut villages and a warm Gurian welcome.',
        duration: 'Day trip',
        regionActivity: 'Guria · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nino-gakhokia-24d9N5UsVYs-unsplash.jpg',
        href: '/en/tours/guria-discovery',
      },
      {
        name: 'West Georgia Loop — Guria to Adjara',
        hook: 'Green hills, coastal beaches and the highlands of Adjara in one sweep.',
        duration: '3 days',
        regionActivity: 'Guria · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/zviad-pharsenadze--cIcGJX4Gxk-unsplash.jpg',
        href: '/en/tours/west-georgia-loop',
      },
    ],
  ...
  // ── SHIDA KARTLI ─────────────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'Uplistsikhe & Gori Day Trip',
        hook: "Georgia's oldest cave city and the birthplace of Stalin — a day of fascinating contradictions.",
        duration: 'Day trip',
        regionActivity: 'Shida Kartli · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nika-tchokhonelidze-Ms_p0I5DQSM-unsplash.jpg',
        href: '/en/tours/uplistsikhe-gori',
      },
      {
        name: 'Ancient Kartli Heritage Tour',
        hook: 'Cave city, medieval church and the storied Mtkvari valley on one route.',
        duration: 'Day trip',
        regionActivity: 'Shida Kartli · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
  ...
  // ── KVEMO KARTLI ─────────────────────────────────────────────────────────────
  {
    ...
    tours: [
      {
        name: 'David Gareja Day Trip',
        hook: 'Cave monastery, desert mesa and extraordinary frescoes an hour from Tbilisi.',
        duration: 'Day trip',
        regionActivity: 'Kvemo Kartli · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/jason-gardner-LU-o3CbeZhU-unsplash.jpg',
        href: '/en/tours/david-gareja',
      },
      {
        name: 'Southern Georgia Heritage Loop',
        hook: "David Gareja, Bolnisi Sioni and the frontier landscapes of Georgia's deep south.",
        duration: '2 days',
        regionActivity: 'Kvemo Kartli · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nino-gakhokia-24d9N5UsVYs-unsplash.jpg',
        href: '/en/tours/south-georgia-heritage',
      },
    ],
  ...
  // ── TBILISI ──────────────────────────────────────────────────────────────────
  {
    ...
    tours: [
      ...
      {
        name: 'Highlights of Georgia',
        hook: 'Mountains, wine, caves and old towns in one loop — starting from Tbilisi.',
        duration: '7 days',
        regionActivity: 'Tbilisi · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
      ...
      {
        name: 'Tbilisi Old Town Walk',
        hook: 'Narikala, the sulfur baths, the Old Town and a wine tasting — Tbilisi in a day.',
        duration: 'Day trip',
        regionActivity: 'Tbilisi · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
        badge: '',
        image: '/images/tours/nika-tchokhonelidze-Ms_p0I5DQSM-unsplash.jpg',
        href: '/en/tours/tbilisi-walk',
      },
      {
        name: 'Mtskheta & Jvari Half-Day',
        hook: "Georgia's ancient royal capital and a UNESCO monastery above the river confluence.",
        duration: 'Half day',
        regionActivity: 'Tbilisi · Mixed Tours',
        difficulty: 'Easy',
        isNew: false,
