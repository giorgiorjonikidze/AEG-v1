...
// Previous version of the About page, kept online at /en/about-old for reference.
// Not linked from the site and excluded from search + sitemap.
// Deliberately self-contained (its own GUIDES copy) so it stays frozen as it was
// on 2026-07-30, whatever the live pages change to later.
export const metadata: Metadata = {
  title: 'About Our Local Guides (previous version)',
  description:
...
const GUIDES = [
  ...
  },
  {
    ...
    alt: 'Tsotne, climbing and caving guide for Adventure Experts Georgia',
  },
  {
    id: 'rezi',
    name: 'Rezi',
